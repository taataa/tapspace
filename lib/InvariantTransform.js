...
var InvariantTransform = function (transf, plane) {
  ...
  //
  // Example
  //   var t = new taaspace.InvariantTransform(tr, pixel)
  //
  // Parameter
  //   transf
...
proto.inverse = function () {
  ...
  return new InvariantTransform(this._tr.inverse())
}
...
proto.transformBy = function (itr) {
  ...
  //     an InvariantTransform
  //
  return new InvariantTransform(itr._tr.multiplyBy(this._tr))
}

proto.relativeTo = function (itr) {
  // Return an InvariantTransform T that when multiplied from right
  ...
  //     InvariantTransform
  //
  return new InvariantTransform(this._tr.multiplyBy(itr._tr.inverse()))
}
...
proto.translate = function (domain, range) {
  ...
  //   an InvariantTransform
  //
  var itr = InvariantTransform.estimate('T', domain, range)
...
proto.scale = function (pivot, multiplierOrDomain, range) {
  ...
  if (useMultiplier) {
    ...
    itr = InvariantTransform.estimate('S', domain, range, pivot)
...
proto.rotate = function (pivot, radiansOrDomain, range) {
  ...
  if (useRadians) {
    ...
    itr = InvariantTransform.estimate('R', domain, range, pivot)
    return itr.multiplyBy(this)
  }
}
...
proto.translateScale = function (domain, range) {
  ...
  //   domain: array of InvariantVector
  //   range: array of InvariantVector
  var itr = InvariantTransform.estimate('TS', domain, range)
  return itr.multiplyBy(this)
}
...
proto.translateRotate = function (domain, range) {
  ...
  //   domain: array of InvariantVector
  //   range: array of InvariantVector
  var itr = InvariantTransform.estimate('TR', domain, range)
  return itr.multiplyBy(this)
}
...
proto.scaleRotate = function (pivot, domain, range) {
  ...
  //   domain: array of InvariantVector
  //   range: array of InvariantVector
  var itr = InvariantTransform.estimate('SR', domain, range, pivot)
  return itr.multiplyBy(this)
}
...
proto.translateScaleRotate = function (domain, range) {
  ...
  //   domain: array of InvariantVector
  //   range: array of InvariantVector
  var itr = InvariantTransform.estimate('TSR', domain, range)
  return itr.multiplyBy(this)
}

// Class methods

InvariantTransform.IDENTITY = new InvariantTransform()
...
InvariantTransform.estimate = function (type, domain, range, pivot) {
  ...
  //   domain
  //     InvariantPath or array of InvariantVector
  //   range
  //     InvariantPath or array of InvariantVector
  //   pivot
