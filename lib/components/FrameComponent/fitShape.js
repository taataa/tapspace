...
// display, show, jumpTo, flyTo
// scaleToExterior, scaleToInterior, scaleToFit, scaleToContain
// scaleToFitInside, scaleToFitOutside
// scaleToLimits, scaleToFill, scaleToFit
//
module.exports = function (target, options) {
  // @FrameComponent:fitShape(target, options)
  //
  ...
  // Parameters:
  //   target
  //     a Path or a FrameComponent, the shape.
  //   options
  //     translate
