...
module.exports = function (newSize, pivot) {
  // @FrameComponent:resizeTo(newSize[, pivot])
  //
  ...
  // the space position of the top left corner, see FrameComponent:setSize.
  //
  // Parameters:
  //   newSize
  //     a {w,h}, a {width,height}, or a Size.
  //     .. The dimensions must be numbers. CSS length strings are not supported.
  //   pivot
