...
const FrameComponent = function (element) {
  ...
  // TODO rename to PhysicalComponent?
  ...
  // Component mass determines its solidity.
  // Camera can travel deeper through a non-solid, massless component.
  // Camera cannot easily travel through a solid, and
  // instead, it zooms and scales in on the component, according to its mass.
  // Massive components allow for smaller scale until the camera goes through.
  // Default mass is zero but subclasses, such as Item, may prefer
  // infinity by default.
  this.mass = 0
}
