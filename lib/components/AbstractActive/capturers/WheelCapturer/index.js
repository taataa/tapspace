...
const selectPoint = require('./selectPoint')
...
const WheelCapturer = function (component, options) {
  ...
  //     coordinateSystem
  //       optional string, default 'page'.
  //       ..Instructs the capturer which browser coordinates to use.
  //       ..Possible values: 'client', 'offset', 'page', 'screen'.
  //
  // Emits
