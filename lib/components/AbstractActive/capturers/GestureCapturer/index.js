...
const GestureCapturer = function (component, options) {
  ...
  //           center
  //             optional point2 on view or Point.
  ...
  // TODO normalise freedom center on the root.
  // TODO normalise freedom angle on the root.
  ...
  const onMove = (prevPointers, nextPointers) => {
    ...
    const freedom = self.options.freedom
    const tr = nudged.estimate({
      estimator: freedom.type,
      domain: domain,
      range: range,
