...
const AbstractView = function (element, opts) {
  ...
  // At the same time, it is a component floating in space.
  //
  // Parameters
  //   element
...
proto.transformSpaceBy = require('./transformSpaceBy')

// Overwrite AbstractPlane:translateBy to apply to each root plane.
proto.translateBy = require('./translateBy')

// Special translation method to move the space content.
proto.translateSpaceBy = require('./translateSpaceBy')
