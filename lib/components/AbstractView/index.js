...
const AbstractView = function (element, opts) {
  ...
  this.layersElem.className = 'affine-space'
  this.element.appendChild(this.layersElem)
  ...
  this.controlsElem.className = 'affine-controls'
  this.element.appendChild(this.controlsElem)
