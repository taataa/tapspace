...
const CircleElement = function (radius, color) {
  // @CircleElement(radius, color)
  //
  // Inherits Item
  //
  // A colorful circle.
...
const proto = CircleElement.prototype
proto.isCircle = true
...
// Functions
CircleElement.create = require('./create')(CircleElement)
