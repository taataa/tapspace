...
const Viewport = function (element) {
  // @Viewport(element)
  //
  // Inherits BlockComponent and InteractiveComponent
  //
  ...
  // The projection type contols many interaction and projection details.
  this.proj = '2d'

  // Camera distance gives the projection perspective for 3D projection.
  // The camera distance is stored as a number representing viewport pixels.
  // The number tells the distance of the camera from the viewport plane.
...
proto.balanceScale = require('./balanceScale')
proto.findMostDistant = require('./findMostDistant')
proto.findNearestProjected = require('./findNearestProjected')
...
proto.projection = require('./projection')
...
proto.setProjection = proto.projection
proto.toPage = require('./toPage')
proto.translateTowards = require('./translateTowards')
