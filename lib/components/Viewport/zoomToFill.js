...
module.exports = function (target, margin) {
  // @Viewport:zoomToFill(target, margin)
  //
  ...
  //     .. Amount of margin to leave between the target and viewport bounds.
  //     .. For example, value `50` will make the viewport fill the area
  //     .. that we would get if we expanded the target by 50 viewport pixels
  //     .. in every direction.
  //
  // Return
  //   this, for chaining
  ...
  // TODO
  // TODO Pick larger in order to fill.
