module.exports = function (maxDistance) {
  ...
  // the viewport anchor to the component anchor.
  //
  // Parameters:
  //   maxDistance
  //     a Distance or a number in viewport pixels.
  //     .. The radius from the viewport anchor
  //
  // Return
  ...
  return this.measureAll().filter((measure) => {
    return measure.distanceToCamera <= maxDistance
  }).map((measure) => {
