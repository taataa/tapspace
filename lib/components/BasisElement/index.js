...
const BasisElement = function (element) {
  // @BasisElement(element)
  //
  // Inherits Emitter
  //
  // BasisElement is an abstract class for all affine components that have
...
module.exports = BasisElement
const proto = BasisElement.prototype
proto.isBasisElement = true

// Inherit
emitter(proto)

// Functions
BasisElement.findAffineAncestor = require('./dom/findAffineAncestor')
BasisElement.isAffine = require('./dom/isAffine')
