...
module.exports = function (params) {
  ...
  //       ..fixed center of rotation and scaling.
  //     angle
  ...
  if (params.pivot) {
    ...
    if (c.basis) {
      ...
      pivot = point2.transitFrom(c.point, pr) // c becomes plain {x,y}
    } else {
      // Assume the point is already on the plane.
      pivot = { x: c.x, y: c.y } // copy to ensure immutability
    }
  }
