...
module.exports = function (edge, view) {
  // renderTrackingTransform()
  //
  // Draw 3D edge so that it is always facing the camera.
  //
  ...
  // Camera position
  const camera = view.atCamera().transitRaw(edge)
  ...
  const vac = point3.delta(start, camera)
