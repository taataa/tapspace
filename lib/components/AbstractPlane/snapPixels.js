...
module.exports = function (options) {
  ...
  const tol = 0.02
  if (abs(plane.a) < tol || abs(plane.b) < tol) {
    ...
    plane = geom.plane3.rotateToOrtho(plane, center)
    ...
    // Note that we avoid modifying this.plane.
    ...
    // console.log('original plane', this.plane)
    // console.log('adjusted plane', plane)
  }
