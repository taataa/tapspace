module.exports = function (component, placement) {
  // tapspace.components.AbstractPlane:addChild(component, placement)
  //
  ...
  //     an AbstractPlane
  //   placement
  //     a {x,y,z} or a Point or a placement object with the following props:
  //       anchor
  ...
  //         ..intentionally prepared plane instead of the default
  ...
  // }, placement)
  //
  // // Compute the placement as plane.
  ...
  const anchor = component.atAnchor()
  component.moveTo(placement, 0, 1, anchor)
