...
const Arc = function (angle, border) {
  ...
  // Make the circle behave like interaction proxy.
  // Without, the circle would steal events, blocking navigatio.
  circle.classList.add('affine-proxy-pointer')
  circle.classList.add('affine-proxy-wheel')

  stencil.appendChild(circle)
  this.circle = circle

  // The stencil becomes this.element
  FrameComponent.call(this, stencil)
