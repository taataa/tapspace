module.exports = function (oldChild, newChild) {
  // @BasisComponent:replaceChild(oldChild, newChild)
  //
  ...
  // Parameters:
  //   oldChild
  //     a BasisComponent. Will be removed from the document.
  //   newChild
  //     a BasisComponent. Will be added to the document or reparented.
  //
  // Return
  //   this, for chaining
  //
  ...
  if (!oldChild.isBasisComponent) {
    throw new Error('Cannot replace non-affine element.')
  }
  if (!newChild.isBasisComponent) {
