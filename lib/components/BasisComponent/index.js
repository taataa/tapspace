...
const BasisComponent = function (element) {
  // @BasisComponent(element)
  //
  // Inherits Emitter
  //
  // BasisComponent is an abstract class for all affine components that have
...
const proto = BasisComponent.prototype
proto.isBasisComponent = true

// Inherit
emitter(proto)

// Functions
BasisComponent.findAffineAncestor = require('./dom/findAffineAncestor')
BasisComponent.isAffine = require('./dom/isAffine')
