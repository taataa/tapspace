...
const AffineSpace = require('../Space')
...
proto.createSpaceAt = function (placement) {
  // Create new AffineSpace and insert it into the viewport.
  //
  // Parameters:
  //   placement
  //     origin
  //       Point on the viewport, position of space at (0,0)
  //     rotation
  //       number, radians
  //     scale
  //       number, multiplier
  ...
  spaceEl.className = 'affine-space'

  const space = new AffineSpace(spaceEl)

  this.el.appendChild(spaceEl)
