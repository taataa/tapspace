...
var SpacePlane = function () {
  ...
  //   x_space = T * x_space
  this._T = nudged.Transform.IDENTITY // identity transformation
}
...
p.at = function (xy) {
  ...
  if (xy.length !== 2) {  // DEBUG TODO remove this
    throw new Error('Invalid point, use array [x, y]')
  }
...
p.getGlobalTransform = function () {
  ...
  if (this._parent === null) {
    ...
    return new SpaceTransform(plane)  // This is root, thus identity
  }
  // else this is a descendant of root (= a Space)
