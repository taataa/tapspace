...
var Manager = function (element, plane, view, emitter, mode) {
  ...
  //   plane
  //     a taaspace.SpacePlane, the object to move
  //   view
  //     a taaspace.SpaceView
  //   emitter
  ...
  var onMove = function (prevPointers, nextPointers) {
    ...
    if (self.view === self.plane) {
      ...
      // Shortcut for:
      //   itr = new taaspace.geom.ITransform(tr, plane)
