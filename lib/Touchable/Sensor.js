...
var Sensor = function (element, handlers, propagate) {
  // Parameters:
  //   element
  ...
  var onTouchStart = function (ev) {
    ...
    nextPointers = utils.clone(currPointers) // See [2]
  ...
  var onTouchMove = function (ev) {
    ...
    nextPointers = utils.clone(currPointers)
  ...
  this.element.addEventListener('ratstart', onMouseDown)
  this.element.addEventListener('ratmove', onMouseMove)
  this.element.addEventListener('ratend', onMouseUp)
  ...
  this.listeners.ratstart = onMouseDown
  this.listeners.ratmove = onMouseMove
  this.listeners.ratend = onMouseUp
}

Sensor.prototype.setPropagation = function (enabled) {
