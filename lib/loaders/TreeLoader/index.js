...
const TreeLoader = function (config) {
  ...
  //         .. Fetch the content for id from your data store,
  //         .. store it locally somehow, and then call the callback.
  //         .. The callback is a function (err).
  //       generator
  //         a function (id), synchronous. Render the content element.
  //         .. Called after a successful fetch. Return a Component.
  //       mapper
  ...
  //     const childrenIds = data.points.map(p => p.id)
  //     return childrenIds
  //   },
  //
