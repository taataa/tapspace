...
module.exports = function (dx, dy, dz) {
  ...
  // Parameters:
  //   dx
  //     a Distance, the distance along x-axis of the element basis.
  //     a number, a length in the scale of the element basis.
  //   dy
  //     a Distance, the distance along y-axis of the element basis.
  //     a number, a length in the scale of the element basis.
  //   dz
  //     optional Distance, the distance along z-axis of the element basis.
