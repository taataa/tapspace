...
const GestureCapturer = function (component, options) {
  ...
  // DANGER Do not implement options.stopPropagation. It is known to have unexpected side effects.
  // The app developer should rely only on preventDefault. See [Sensor:3] for more.
