...
const GestureCapturer = function (component, options) {
  ...
  //       delegation
  //         optional string. The delegation mode defines what event targets
  //         .. are to be captured. The targets can be thought of as handles
  //         .. for the component.
  //       preventDefault
  ...
  this.delegation = 'affine'
  if (typeof options.delegation === 'string' &&
      DELEGATION_VALUES.includes(options.delegation)) {
...
proto.update = function (options) {
  ...
  // Delegate updates to sensor (if bound and available)
  if (this.sensor) {
    this.sensor.update({
      delegation: this.delegation,
      preventDefault: this.preventDefault,
