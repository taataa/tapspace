...
const WheelCapturer = function (component, options) {
  ...
  // Parameters:
  //   component
  //     an InteractiveComponent, the source for the wheel events
  ...
  //   component
  //     an InteractiveComponent on which the center is measured.
  //     .. The viewport.
  //   target
  //     a BasisComponent closest to the original event target.
  //   deltaX
