...
module.exports = (tr, viewport, target) => {
  ...
  // Parameters:
  //   tr
  //     a helm2, the transformation to adjust
  //   viewport
  ...
  const cam = viewport.atCamera()
  const trProjected = geom.helm2.projectTo(tr, targetPlane, cam)
  // Projected is represented on the target.
  // The target may have rotations and scalings.
  // Transit back to view.
  const trProjOnView = geom.helm2.transitFrom(trProjected, targetPlane)
  return trProjOnView
}
