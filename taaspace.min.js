...
var Emitter=require("component-emitter"),SpaceContainer=require("./SpaceContainer"),SpacePlane=require("./SpacePlane"),Transformer=require("./Transformer"),SpaceRectangle=require("./SpaceRectangle"),SpaceTaa=require("./SpaceTaa"),SpaceHTML=require("./SpaceHTML"),move=require("movejs");move.defaults={duration:0};var HTMLSpaceView=function(e,t){if(!("tagName"in t))throw"Container should be a DOM Element";Emitter(this),SpaceContainer(this),SpacePlane(this),Transformer(this),SpaceRectangle(this);var n=this;this._el=t,this._elements={},this._spacetaas={},function(){var e=n._el.clientWidth,t=n._el.clientHeight;n.resize([e,t])}();var a=function(e,t){var a=t.getGlobalTransform(),i=n._T.inverse().multiplyBy(a),s=8,r=i.s.toFixed(s),o=i.r.toFixed(s),l=i.tx.toFixed(s),c=i.ty.toFixed(s);move(e).matrix(r,o,-o,r,l,c).end()},i=function(e){return n.id+"/"+e},s=function(e,t,s){"undefined"==typeof s&&(s=null),"undefined"==typeof t&&(t=null);var r,o,l;if(r=e,n._elements.hasOwnProperty(r.id));else if(r instanceof SpaceTaa)o=new Image(256,256),o.src=r.taa.image.src,o.id=i(r.id),o.className="taaspace-taa",n._el.appendChild(o),n._elements[r.id]=o,n._spacetaas[r.id]=r,a(o,r);else if(r instanceof SpaceHTML)o=document.createElement("div"),o.innerHTML=r.html,o.id=i(r.id),o.className="taaspace-html",l=r.getSize(),o.style.width=l[0]+"px",o.style.height=l[1]+"px",r.on("resized",function(){var e=r.getSize();o.style.width=e[0]+"px",o.style.height=e[1]+"px"}),n._el.appendChild(o),n._elements[r.id]=o,n._spacetaas[r.id]=r,a(o,r);else if(!(r instanceof HTMLSpaceView))throw new Exception("Unknown space content; cannot represent")},r=function(e,t,a){"undefined"==typeof t&&(t=null),"undefined"==typeof a&&(a=null);var i,s,r;r=e,i=null===t||null===a?!1:t.getRootParent()===a.getRootParent(),i||n._elements.hasOwnProperty(r.id)&&(s=n._elements[r.id],n._el.removeChild(s),delete n._elements[r.id],delete n._spacetaas[r.id])},o=function(e){var t,i,s,r;for(t=e.getAllChildren(),t.push(e),i=0;i<t.length;i+=1)s=t[i],n._elements.hasOwnProperty(s.id)&&(s instanceof SpaceTaa?(r=n._elements[s.id],a(r,s)):s instanceof SpaceHTML&&(r=n._elements[s.id],a(r,s)))};this.on("added",function(e,t){t.on("contentAdded",s),t.on("contentRemoved",r),t.on("contentTransformed",o)}),this.on("removed",function(e,t){t.off("contentAdded",s),t.off("contentRemoved",r),t.off("contentTransformed",o)}),this.on("transformed",function(){var e,t,i;for(e in n._elements)n._elements.hasOwnProperty(e)&&(t=n._elements[e],i=n._spacetaas[e],a(t,i))}),this.getElementBySpaceTaa=function(e){return this._elements.hasOwnProperty(e.id)?this._elements[e.id]:void 0},this.getSpaceTaaByElementId=function(e){var t=e.split("/"),n=t[0],a=t[1];return this.id===n&&this._spacetaas.hasOwnProperty(a)?this._spacetaas[a]:null},this.getRootElement=function(){return this._el},this.setParent(e)};module.exports=HTMLSpaceView;
},{"./SpaceContainer":25,"./SpaceHTML":26,"./SpacePlane":27,"./SpaceRectangle":29,"./SpaceTaa":30,"./Transformer":33,"component-emitter":1,"movejs":3}],24:[function(require,module,exports){
var Emitter=require("component-emitter"),SpacePlane=require("./SpacePlane"),SpaceContainer=require("./SpaceContainer"),Space=function(){Emitter(this),SpaceContainer(this),SpacePlane(this)};module.exports=Space;
},{"./SpaceContainer":25,"./SpacePlane":27,"component-emitter":1}],25:[function(require,module,exports){
var Emitter=require("component-emitter"),seqid=require("seqid")(0),SpaceContainer=function(t){t.id=seqid.next().toString(),t._parent=null,t._content={},t._addedHandlers={},t._removedHandlers={},t._transformedHandlers={},t.has=function(t){return t._parent===this},t.getParent=function(){return this._parent},t.getRootParent=function(){return null===this._parent?this:this._parent.getRootParent()},t.getChildren=function(){var t,e,n;e=[],n=this._content;for(t in n)e.push(n[t]);return e},t.getAllChildren=function(){var t,e,n,d;for(d=[],e=this.getChildren(),t=0;t<e.length;t+=1)n=e[t],d=d.concat(n,n.getAllChildren());return d},t.setParent=function(t){var e=this._parent;null===e?null===t||(this._parent=t,this._parent._addChild(this),this.emit("added",this,this._parent,null),t.emit("contentAdded",this,this._parent,null)):null===t?(this._parent=null,e._removeChild(this),this.emit("removed",this,e,null),e.emit("contentRemoved",this,e,null)):(this._parent=t,e._removeChild(this),t._addChild(this),this.emit("removed",this,e,t),this.emit("added",this,t,e),e.emit("contentRemoved",this,e,t),t.emit("contentAdded",this,t,e))},t.remove=function(){return this.setParent(null)},t._addChild=function(t){var e=t,n=this;this._content[e.id]=e;var d=function(t,e,d){n.emit("contentAdded",t,e,d)},i=function(t,e,d){n.emit("contentRemoved",t,e,d)},r=function(t,e,d){n.emit("contentTransformed",t,e,d)};e.on("contentAdded",d),e.on("contentRemoved",i),e.on("transformed",r),e.on("contentTransformed",r),this._addedHandlers[e.id]=d,this._removedHandlers[e.id]=i,this._transformedHandlers[e.id]=r},t._removeChild=function(t){var e,n;e=t,delete this._content[e.id],n=this._addedHandlers[e.id],delete this._addedHandlers[e.id],e.off("contentAdded",n),n=this._removedHandlers[e.id],delete this._removedHandlers[e.id],e.off("contentRemoved",n),n=this._transformedHandlers[e.id],delete this._transformedHandlers[e.id],e.off("transformed",n),e.off("contentTransformed",n)}};module.exports=SpaceContainer;
},{"component-emitter":1,"seqid":22}],26:[function(require,module,exports){
var Emitter=require("component-emitter"),SpaceContainer=require("./SpaceContainer"),SpacePlane=require("./SpacePlane"),Transformer=require("./Transformer"),SpaceRectangle=require("./SpaceRectangle"),SpaceHTML=function(e,r){Emitter(this),SpaceContainer(this),SpacePlane(this),Transformer(this),SpaceRectangle(this),this.html=r,this.resize([256,256]),this.setParent(e)};module.exports=SpaceHTML;
},{"./SpaceContainer":25,"./SpacePlane":27,"./SpaceRectangle":29,"./Transformer":33,"component-emitter":1}],27:[function(require,module,exports){
...
var Emitter=require("component-emitter"),SpaceContainer=require("./SpaceContainer"),SpacePlane=require("./SpacePlane"),Transformer=require("./Transformer"),SpaceRectangle=require("./SpaceRectangle"),SpaceTaa=function(e,a){Emitter(this),SpaceContainer(this),SpacePlane(this),Transformer(this),SpaceRectangle(this),this.taa=a,this.resize([256,256]),this.setParent(e)};module.exports=SpaceTaa;
},{"./SpaceContainer":25,"./SpacePlane":27,"./SpaceRectangle":29,"./Transformer":33,"component-emitter":1}],31:[function(require,module,exports){
...
},{"./HTMLSpaceView":23,"./Space":24,"./SpaceHTML":26,"./SpaceTaa":30,"./Taa":31,"./version":35}],35:[function(require,module,exports){
