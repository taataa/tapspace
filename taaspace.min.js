...
var SpacePoint=function(t,o){this.xy=t,this._T=o._T},proto=SpacePoint.prototype;proto.offset=function(t,o){var i=[this.xy[0]+t,this.xy[1]+o];return new SpacePoint(i,this)},proto.polarOffset=function(t,o){var i=this.xy[0]+t*Math.cos(o),n=this.xy[1]+t*Math.sin(o);return new SpacePoint([i,n],this)},proto.equals=function(t){return this.xy[0]===t.xy[0]&&this.xy[1]===t.xy[1]&&this._T.equals(t._T)},proto.to=function(t){if(t._T.equals(this._T))return this;var o=this._T.inverse(),i=t._T.multiplyBy(o),n=i.transform(this.xy);return new SpacePoint(n,t)},proto.transform=function(t){var o=t.transform(this.xy);return new SpacePoint(o,this)},module.exports=SpacePoint;
...
},{"./SpacePlane":25,"./SpaceRectangle":27,"./Transformer":30,"component-emitter":1,"seqid":22}],29:[function(require,module,exports){
...
var nudged=require("nudged"),SpacePoint=require("./SpacePoint"),normalize=function(t,r){var e,n,a,i=[];for(Array.isArray(t)||(t=[t]),e=0;e<t.length;e+=1)n=t[e],a=n.to(r).xy,i.push(a);return i},transformByEstimate=function(t,r,e,n,a){var i;"undefined"!=typeof a&&(i=a.to(t).xy);var s=normalize(e,t),o=normalize(n,t),f=nudged.estimate(r,s,o,i);t._T=f.inverse().multiplyBy(t._T),t.emit("transformed",t)},Transformer=function(t){t.getTransform=function(){return t._T},t.setTransform=function(r){t._T=r,t.emit("transformed",t)},t.translate=function(t,r){transformByEstimate(this,"T",t,r)},t.scale=function(r,e,n){var a="undefined"==typeof n;if(a){var i=r.to(t).xy,s=e;if(!(s>0))throw"Invalid multiplier: "+s;this._T=this._T.scaleBy(1/s,i),t.emit("transformed",t)}else{var o=e;transformByEstimate(this,"S",o,n,r)}},t.rotate=function(r,e,n){var a="undefined"==typeof n;if(a){var i=r.to(t).xy,s=e;this._T=this._T.rotateBy(-s,i),t.emit("transformed",t)}else{var o=e;transformByEstimate(this,"R",o,n,r)}},t.translateScale=function(t,r){transformByEstimate(this,"TS",t,r)},t.translateRotate=function(t,r){transformByEstimate(this,"TR",t,r)},t.scaleRotate=function(t,r,e){transformByEstimate(this,"SR",r,e,t)},t.translateScaleRotate=function(t,r){transformByEstimate(this,"TSR",t,r)}};module.exports=Transformer;
},{"./SpacePoint":26,"nudged":12}],31:[function(require,module,exports){
...
},{"./HTMLSpaceView":23,"./Space":24,"./Taa":29,"./version":32}],32:[function(require,module,exports){
