...
var Emitter=require("component-emitter"),SpacePlane=require("./SpacePlane"),Transformer=require("./Transformer"),SpaceRectangle=require("./SpaceRectangle"),nudged=require("nudged"),move=require("movejs");move.defaults={duration:0};var seqid=require("seqid")(0),HTMLSpaceView=function(e,t){Emitter(this),SpacePlane(this),Transformer(this),SpaceRectangle(this);var i=this;if("object"!=typeof e||!("add"in e))throw"Space should be a Space object";if(!("tagName"in t))throw"Container should be a DOM Element";this.id=seqid.next().toString(),this.space=e,this._el=t,function(){var e=t.clientWidth,a=t.clientHeight;i.resize([e,a])}(),this._elements={},this._spacetaas={};var a=function(e,t){var a=i._T.inverse().multiplyBy(t._T),n=8,s=a.s.toFixed(n),r=a.r.toFixed(n),o=a.tx.toFixed(n),d=a.ty.toFixed(n);move(e).matrix(s,r,-r,s,o,d).end()};this.space.on("contentAdded",function(e){if(i._elements.hasOwnProperty(e.id));else{var t=e.taa,n=new Image(256,256);n.src=t.image.src,n.id=i.id+"/"+e.id,n.className="taaspace-taa",i._el.appendChild(n),i._elements[e.id]=n,i._spacetaas[e.id]=e,a(n,e)}}),this.space.on("contentRemoved",function(e){var t;i._elements.hasOwnProperty(e.id)&&(t=i._elements[e.id],i._el.removeChild(t),delete i._elements[e.id],delete i._spacetaas[e.id])}),this.space.on("contentTransformed",function(e){var t;i._elements.hasOwnProperty(e.id)&&(t=i._elements[e.id],a(t,e))}),this.on("transformed",function(){var e,t,n;for(e in i._elements)i._elements.hasOwnProperty(e)&&(t=i._elements[e],n=i._spacetaas[e],a(t,n))}),this.getElementBySpaceTaa=function(e){return this._elements.hasOwnProperty(e.id)?this._elements[e.id]:void 0},this.getSpaceTaaByElementId=function(e){var t=e.split("/"),i=t[0],a=t[1];return this.id===i&&this._spacetaas.hasOwnProperty(a)?this._spacetaas[a]:null},this.getRootElement=function(){return this._el}},proto=HTMLSpaceView.prototype;module.exports=HTMLSpaceView;
},{"./SpacePlane":25,"./SpaceRectangle":27,"./Transformer":31,"component-emitter":1,"movejs":3,"nudged":12,"seqid":22}],24:[function(require,module,exports){
var Emitter=require("component-emitter"),SpacePlane=require("./SpacePlane"),SpaceTaa=require("./SpaceTaa"),Space=function(){Emitter(this),SpacePlane(this),this.content={},this.transformedHandlers={}},proto=Space.prototype;proto.has=function(e){return e.space===this},proto.add=function(e){var t=new SpaceTaa(this,e);return t},proto._add=function(e){var t=e,r=this;this.content[t.id]=t;var n=function(){r.emit("contentTransformed",t)};t.on("transformed",n),this.transformedHandlers[t.id]=n,this.emit("contentAdded",t)},proto.remove=function(e){this.content.hasOwnProperty(e.id)&&e.remove()},proto._remove=function(e){var t=e;delete this.content[t.id];var r=this.transformedHandlers[t.id];delete this.transformedHandlers[t.id],e.off("transformed",r),this.emit("contentRemoved",t)},module.exports=Space;
},{"./SpacePlane":25,"./SpaceTaa":28,"component-emitter":1}],25:[function(require,module,exports){
var nudged=require("nudged"),SpacePoint=require("./SpacePoint"),at=function(e){if(2!==e.length)throw"Invalid point, use array [x, y]";return new SpacePoint(e,this)},SpacePlane=function(e){e._T=new nudged.Transform(1,0,0,0),e.at=at};module.exports=SpacePlane;
},{"./SpacePoint":26,"nudged":12}],26:[function(require,module,exports){
var Transform=require("./Transform"),SpacePoint=function(t,r){this.xy=t,this._T=r._T},proto=SpacePoint.prototype;proto.offset=function(t,r){var o=[this.xy[0]+t,this.xy[1]+r];return new SpacePoint(o,this)},proto.polarOffset=function(t,r){var o=this.xy[0]+t*Math.cos(r),n=this.xy[1]+t*Math.sin(r);return new SpacePoint([o,n],this)},proto.equals=function(t){return this.xy[0]===t.xy[0]&&this.xy[1]===t.xy[1]&&this._T.equals(t._T)},proto.to=function(t){if(t._T.equals(this._T))return this;var r=t._T.inverse().multiplyBy(this._T),o=r.transform(this.xy);return new SpacePoint(o,t)},proto.toSpace=function(){var t=this._T.transform(this.xy),r={_T:Transform.IDENTITY};return new SpacePoint(t,r)},proto.transform=function(t){var r=t.transform(this.xy);return new SpacePoint(r,this)},module.exports=SpacePoint;
},{"./Transform":30}],27:[function(require,module,exports){
var SpacePoint=require("./SpacePoint"),SpaceRectangle=function(n){var t=n,e=1,i=1;t.resize=function(n){e=n[0],i=n[1],t.emit("resized",t)},t.getSize=function(){return[e,i]},t.atNorm=function(n){return new SpacePoint([e*n[0],i*n[1]],t)},t.atMid=function(){return new SpacePoint([e/2,i/2],t)},t.atMidN=function(){return new SpacePoint([e/2,0],t)},t.atMidW=function(){return new SpacePoint([0,i/2],t)},t.atMidE=function(){return new SpacePoint([e,i/2],t)},t.atMidS=function(){return new SpacePoint([e/2,i],t)},t.atNW=function(){return new SpacePoint([0,0],t)},t.atNE=function(){return new SpacePoint([e,0],t)},t.atSW=function(){return new SpacePoint([0,i],t)},t.atSE=function(){return new SpacePoint([e,i],t)}};module.exports=SpaceRectangle;
},{"./SpacePoint":26}],28:[function(require,module,exports){
var Emitter=require("component-emitter"),SpacePlane=require("./SpacePlane"),Transformer=require("./Transformer"),SpaceRectangle=require("./SpaceRectangle"),seqid=require("seqid")(0),SpaceTaa=function(e,t){Emitter(this),SpacePlane(this),Transformer(this),SpaceRectangle(this),this.id=seqid.next().toString(),this.space=e,this.taa=t,this.resize([256,256]),e._add(this)},proto=SpaceTaa.prototype;proto.remove=function(){if(this.space){var e=this.space;this.space=null,e._remove(this),this.emit("removed",this,e)}},module.exports=SpaceTaa;
},{"./SpacePlane":25,"./SpaceRectangle":27,"./Transformer":31,"component-emitter":1,"seqid":22}],29:[function(require,module,exports){
...
},{"component-emitter":1,"loadimages":2}],30:[function(require,module,exports){
var nudged=require("nudged");module.exports=nudged.Transform;
},{"nudged":12}],31:[function(require,module,exports){
var nudged=require("nudged"),Transform=require("./Transform"),SpacePoint=require("./SpacePoint"),normalize=function(t){var r,e,a,n;if(!Array.isArray(t))return e=t,a=e.toSpace().xy,[a];for(n=[],r=0;r<t.length;r+=1)e=t[r],a=e.toSpace().xy,n.push(a);return n},transformByEstimate=function(t,r,e,a,n){var i;"undefined"!=typeof n&&(i=normalize(n)[0]);var s=normalize(e),o=normalize(a),m=nudged.estimate(r,s,o,i);t._T=m.multiplyBy(t._T),t.emit("transformed",t)},Transformer=function(t){t.getTransform=function(){return this._T},t.setTransform=function(t){this._T=t,this.emit("transformed",this)},t.translate=function(t,r){transformByEstimate(this,"T",t,r)},t.scale=function(r,e,a){var n="undefined"==typeof a;if(n){var i=normalize(r)[0],s=e,o=Transform.IDENTITY.scaleBy(s,i);this._T=o.multiplyBy(this._T),t.emit("transformed",t)}else{var m=e;transformByEstimate(this,"S",m,a,r)}},t.rotate=function(r,e,a){var n="undefined"==typeof a;if(n){var i=normalize(r)[0],s=e,o=Transform.IDENTITY.rotateBy(s,i);this._T=o.multiplyBy(this._T),t.emit("transformed",t)}else{var m=e;transformByEstimate(this,"R",m,a,r)}},t.translateScale=function(t,r){transformByEstimate(this,"TS",t,r)},t.translateRotate=function(t,r){transformByEstimate(this,"TR",t,r)},t.scaleRotate=function(t,r,e){transformByEstimate(this,"SR",r,e,t)},t.translateScaleRotate=function(t,r){transformByEstimate(this,"TSR",t,r)}};module.exports=Transformer;
},{"./SpacePoint":26,"./Transform":30,"nudged":12}],32:[function(require,module,exports){
exports.Taa=require("./Taa"),exports.Space=require("./Space"),exports.HTMLSpaceView=require("./HTMLSpaceView"),exports.version=require("./version");
},{"./HTMLSpaceView":23,"./Space":24,"./Taa":29,"./version":33}],33:[function(require,module,exports){
