...
var Emitter=require("component-emitter"),SpaceNode=require("./SpaceNode"),SpacePlane=require("./SpacePlane"),Transformer=require("./Transformer"),SpaceRectangle=require("./SpaceRectangle"),SpaceTaa=require("./SpaceTaa"),SpaceHTML=require("./SpaceHTML"),Space=require("./Space"),move=require("movejs");move.defaults={duration:0};var HTMLSpaceView=function(e,t){if(!(e instanceof Space))throw"Parent of a View must be a Space.";if(!("tagName"in t))throw"Container should be a DOM Element";Emitter(this),SpaceNode(this),SpacePlane(this),Transformer(this),SpaceRectangle(this);var n=this;this._el=t,this._elements={},this._nodes={},function(){var e=n._el.clientWidth,t=n._el.clientHeight;n.resize([e,t])}();var i=function(e,t){var i=t.getGlobalTransform(),a=n._T.inverse().multiplyBy(i),o=8,r=a.s.toFixed(o),s=a.r.toFixed(o),d=a.tx.toFixed(o),l=a.ty.toFixed(o);move(e).matrix(r,s,-s,r,d,l).end()},a=function(e){return n.id+"/"+e},o=function(e,t,o){"undefined"==typeof o&&(o=null),"undefined"==typeof t&&(t=null);var r,s,d;if(r=e,e.getRootParent()===n.getRootParent())if(n._elements.hasOwnProperty(r.id));else if(r instanceof SpaceTaa)s=new Image(256,256),s.src=r.taa.image.src,s.id=a(r.id),s.className="taaspace-taa",n._el.appendChild(s),n._elements[r.id]=s,n._nodes[r.id]=r,i(s,r);else if(r instanceof SpaceHTML)s=document.createElement("div"),s.innerHTML=r.html,s.id=a(r.id),s.className="taaspace-html",d=r.getSize(),s.style.width=d[0]+"px",s.style.height=d[1]+"px",r.on("resized",function(){var e=r.getSize();s.style.width=e[0]+"px",s.style.height=e[1]+"px"}),n._el.appendChild(s),n._elements[r.id]=s,n._nodes[r.id]=r,i(s,r);else if(!(r instanceof HTMLSpaceView))throw new Exception("Unknown SpaceNode subtype; cannot represent")},r=function(e,t,i){"undefined"==typeof t&&(t=null),"undefined"==typeof i&&(i=null);var a,o,r;r=e,a=null===t||null===i?!1:t.getRootParent()===i.getRootParent(),a||n._elements.hasOwnProperty(r.id)&&(o=n._elements[r.id],n._el.removeChild(o),delete n._elements[r.id],delete n._nodes[r.id])},s=function(e){var t,a,o,r;for(t=e.getDescendants(),t.push(e),a=0;a<t.length;a+=1)o=t[a],n._elements.hasOwnProperty(o.id)&&(o instanceof SpaceTaa?(r=n._elements[o.id],i(r,o)):o instanceof SpaceHTML&&(r=n._elements[o.id],i(r,o)))};this.on("added",function(e,t,n){var i,a;if(n!==t){for(i=t.getDescendants(),a=0;a<i.length;a+=1)o(i[a]);t.on("contentAdded",o),t.on("contentRemoved",r),t.on("contentTransformed",s)}}),this.on("removed",function(e,t,n){var i,a;if(n!==t)for(t.off("contentAdded",o),t.off("contentRemoved",r),t.off("contentTransformed",s),i=t.getDescendants(),a=0;a<i.length;a+=1)r(i[a])}),this.on("transformed",function(){var e,t,a;for(e in n._elements)n._elements.hasOwnProperty(e)&&(t=n._elements[e],a=n._nodes[e],i(t,a))}),this.getElementBySpaceNode=function(e){return this._elements.hasOwnProperty(e.id)?this._elements[e.id]:null},this.getSpaceNodeByElementId=function(e){var t=e.split("/"),n=t[0],i=t[1];return this.id===n&&this._nodes.hasOwnProperty(i)?this._nodes[i]:null},this.getRootElement=function(){return this._el};var d=this.setParent;this.setParent=function(e){if(!(e instanceof Space))throw"A View can only be a child of a Space";d.call(this,e)},this.setParent(e)};module.exports=HTMLSpaceView;
