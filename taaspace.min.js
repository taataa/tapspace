...
var Emitter=require("component-emitter"),SpaceNode=require("./SpaceNode"),SpacePlane=require("./SpacePlane"),Transformer=require("./Transformer"),SpaceRectangle=require("./SpaceRectangle"),SpaceTaa=require("./SpaceTaa"),SpaceHTML=require("./SpaceHTML"),move=require("movejs");move.defaults={duration:0};var HTMLSpaceView=function(e,t){if(!("tagName"in t))throw"Container should be a DOM Element";Emitter(this),SpaceNode(this),SpacePlane(this),Transformer(this),SpaceRectangle(this);var n=this;this._el=t,this._elements={},this._nodes={},function(){var e=n._el.clientWidth,t=n._el.clientHeight;n.resize([e,t])}();var i=function(e,t){var i=t.getGlobalTransform(),a=n._T.inverse().multiplyBy(i),o=8,s=a.s.toFixed(o),r=a.r.toFixed(o),d=a.tx.toFixed(o),l=a.ty.toFixed(o);move(e).matrix(s,r,-r,s,d,l).end()},a=function(e){return n.id+"/"+e},o=function(e,t,o){"undefined"==typeof o&&(o=null),"undefined"==typeof t&&(t=null);var s,r,d;if(s=e,n._elements.hasOwnProperty(s.id));else if(s instanceof SpaceTaa)r=new Image(256,256),r.src=s.taa.image.src,r.id=a(s.id),r.className="taaspace-taa",n._el.appendChild(r),n._elements[s.id]=r,n._nodes[s.id]=s,i(r,s);else if(s instanceof SpaceHTML)r=document.createElement("div"),r.innerHTML=s.html,r.id=a(s.id),r.className="taaspace-html",d=s.getSize(),r.style.width=d[0]+"px",r.style.height=d[1]+"px",s.on("resized",function(){var e=s.getSize();r.style.width=e[0]+"px",r.style.height=e[1]+"px"}),n._el.appendChild(r),n._elements[s.id]=r,n._nodes[s.id]=s,i(r,s);else if(!(s instanceof HTMLSpaceView))throw new Exception("Unknown SpaceNode subtype; cannot represent")},s=function(e,t,i){"undefined"==typeof t&&(t=null),"undefined"==typeof i&&(i=null);var a,o,s;s=e,a=null===t||null===i?!1:t.getRootParent()===i.getRootParent(),a||n._elements.hasOwnProperty(s.id)&&(o=n._elements[s.id],n._el.removeChild(o),delete n._elements[s.id],delete n._nodes[s.id])},r=function(e){var t,a,o,s;for(t=e.getDescendants(),t.push(e),a=0;a<t.length;a+=1)o=t[a],n._elements.hasOwnProperty(o.id)&&(o instanceof SpaceTaa?(s=n._elements[o.id],i(s,o)):o instanceof SpaceHTML&&(s=n._elements[o.id],i(s,o)))};this.on("added",function(e,t){t.on("contentAdded",o),t.on("contentRemoved",s),t.on("contentTransformed",r)}),this.on("removed",function(e,t){t.off("contentAdded",o),t.off("contentRemoved",s),t.off("contentTransformed",r)}),this.on("transformed",function(){var e,t,a;for(e in n._elements)n._elements.hasOwnProperty(e)&&(t=n._elements[e],a=n._nodes[e],i(t,a))}),this.getElementBySpaceNode=function(e){return this._elements.hasOwnProperty(e.id)?this._elements[e.id]:void 0},this.getSpaceNodeByElementId=function(e){var t=e.split("/"),n=t[0],i=t[1];return this.id===n&&this._nodes.hasOwnProperty(i)?this._nodes[i]:null},this.getRootElement=function(){return this._el},this.setParent(e)};module.exports=HTMLSpaceView;
