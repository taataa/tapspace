...
var nudged=require("nudged"),SpacePoint=require("./SpacePoint"),at=function(n){if(2!==n.length)throw"Invalid point, use array [x, y]";return new SpacePoint(this,n)},SpacePlane=function(n){n._T=nudged.Transform.IDENTITY,n.at=at,n.getTransform=function(){return this._T},n.getGlobalTransform=function(){return null===this._parent?this._T:this._parent.getGlobalTransform().multiplyBy(this._T)},n.resetTransform=function(){this._T=nudged.Transform.IDENTITY}};module.exports=SpacePlane;
},{"./SpacePoint":29,"nudged":12}],29:[function(require,module,exports){
var Transform=require("./Transform"),SpacePoint=function(t,r){"undefined"==typeof r&&(r=[0,0]),this.xy=r,t.hasOwnProperty("getGlobalTransform")?this._T=t.getGlobalTransform():this._T=t._T},proto=SpacePoint.prototype;proto.equals=function(t){return this.xy[0]===t.xy[0]&&this.xy[1]===t.xy[1]&&this._T.equals(t._T)},proto.offset=function(t,r){var o=[this.xy[0]+t,this.xy[1]+r];return new SpacePoint(this,o)},proto.polarOffset=function(t,r){var o=this.xy[0]+t*Math.cos(r),n=this.xy[1]+t*Math.sin(r);return new SpacePoint(this,[o,n])},proto.to=function(t){if(null===t)return this.toSpace();var r;if(t.hasOwnProperty("_T"))r=t._T;else{if(!("getGlobalTransform"in t))throw new Error("Cannot convert SpacePoint to: "+t);r=t.getGlobalTransform()}if(r.equals(this._T))return this;var o=r.inverse().multiplyBy(this._T),n=o.transform(this.xy);return new SpacePoint(t,n)},proto.toSpace=function(){var t=this._T.transform(this.xy),r={_T:Transform.IDENTITY};return new SpacePoint(r,t)},proto.transformBy=function(t){var r=t.to(this),o=r.T.transform(this.xy);return new SpacePoint(this,o)},SpacePoint.normalize=function(t,r){var o,n,e;for(e=[],o=0;o<t.length;o+=1)n=t[o],e.push(n.to(r));return e},SpacePoint.toXY=function(t){var r,o;for(o=[],r=0;r<t.length;r+=1)o.push(t[r].xy);return o},SpacePoint.normalizeXY=function(t,r){var o,n,e;for(e=[],o=0;o<t.length;o+=1)n=t[o],e.push(n.to(r).xy);return e},module.exports=SpacePoint;
...
var Transform=require("./Transform"),SpacePoint=require("./SpacePoint"),nudged=require("nudged"),SpaceTransform=function(t,r){if(!t.hasOwnProperty("_T"))throw"invalid reference";if(r&&!r.hasOwnProperty("tx"))throw"invalid transform";"undefined"==typeof r&&(r=Transform.IDENTITY),this.T=r,t.hasOwnProperty("getGlobalTransform")?this._T=t.getGlobalTransform():this._T=t._T},proto=SpaceTransform.prototype;proto.equals=function(t){return this.T.equals(t.T)&&this._T.equals(t._T)},proto.to=function(t){var r,e,a;if(null===t)return this.toSpace();if(t.hasOwnProperty("_T"))r=t._T;else{if(!("getGlobalTransform"in t))throw new Error("Cannot convert SpaceTransform to: "+t);r=t.getGlobalTransform()}return r.equals(this._T)?this:(e=r.inverse().multiplyBy(this._T),a=e.multiplyBy(this.T.multiplyBy(e.inverse())),new SpaceTransform(t,a))},proto.toSpace=function(){var t=this._T.multiplyBy(this.T.multiplyBy(this._T.inverse())),r={_T:Transform.IDENTITY};return new SpaceTransform(r,t)},proto.translate=function(t,r){var e=SpaceTransform.estimate(this,"T",t,r);return new SpaceTransform(this,e.T.multiplyBy(this.T))},proto.scale=function(t,r,e){var a,n,o,s,i;return a="undefined"==typeof e,a?(n=t.to(this),s=this.T.scaleBy(r,n.xy),new SpaceTransform(this,s)):(o=r,i=SpaceTransform.estimate(this,"S",o,e,t),s=i.T.multiplyBy(this.T),new SpaceTransform(this,s))},proto.rotate=function(t,r,e){var a,n,o,s,i;return a="undefined"==typeof e,a?(n=t.to(this),s=this.T.rotateBy(r,n.xy),new SpaceTransform(this,s)):(o=r,i=SpaceTransform.estimate(this,"R",o,e,t),s=i.T.multiplyBy(this.T),new SpaceTransform(this,s))},proto.translateScale=function(t,r){var e=SpaceTransform.estimate(this,"TS",t,r);return new SpaceTransform(this,e.T.multiplyBy(this.T))},proto.translateRotate=function(t,r){var e=SpaceTransform.estimate(this,"TR",t,r);return new SpaceTransform(this,e.T.multiplyBy(this.T))},proto.scaleRotate=function(t,r,e){var a=SpaceTransform.estimate(this,"SR",r,e,t);return new SpaceTransform(this,a.T.multiplyBy(this.T))},proto.translateScaleRotate=function(t,r){var e=SpaceTransform.estimate(this,"TSR",t,r);return new SpaceTransform(this,e.T.multiplyBy(this.T))},SpaceTransform.estimate=function(t,r,e,a,n){var o;"undefined"!=typeof n&&(o=SpacePoint.normalizeXY([n])[0]),e.hasOwnProperty("_T")&&(e=[e]),a.hasOwnProperty("_T")&&(a=[a]);var s=SpacePoint.normalizeXY(e,t),i=SpacePoint.normalizeXY(a,t),T=nudged.estimate(r,s,i,o);return new SpaceTransform(t,T)},module.exports=SpaceTransform;
},{"./SpacePoint":29,"./Transform":35,"nudged":12}],33:[function(require,module,exports){
var nudged=require("nudged"),Transform=require("./Transform"),SpacePoint=require("./SpacePoint"),SpaceTransform=require("./SpaceTransform"),SpaceTransformer=function(t){t.setTransform=function(t){null!==this._parent&&(this._T=t,this.emit("transformed",this))},t.setGlobalTransform=function(t){if(null!==this._parent){var r=this._parent.getGlobalTransform();this._T=r.inverse().multiplyBy(t),this.emit("transformed",this)}},t.transformBy=function(t){if(null!==this._parent){var r=t.to(this._parent);this._T=r.T.multiplyBy(this._T),this.emit("transformed",this)}},t.translate=function(t,r){var e=SpaceTransform.estimate(this,"T",t,r);this.transformBy(e)},t.scale=function(t,r,e){var a=new SpaceTransform(this).scale(t,r,e);this.transformBy(a)},t.rotate=function(t,r,e){var a=new SpaceTransform(this).rotate(t,r,e);this.transformBy(a)},t.translateScale=function(t,r){var e=SpaceTransform.estimate(this,"TS",t,r);this.transformBy(e)},t.translateRotate=function(t,r){var e=SpaceTransform.estimate(this,"TR",t,r);this.transformBy(e)},t.scaleRotate=function(t,r,e){var a=SpaceTransform.estimate(this,"SR",r,e,t);this.transformBy(a)},t.translateScaleRotate=function(t,r){var e=SpaceTransform.estimate(this,"TSR",t,r);this.transformBy(e)},t.on("removed",function(t,r,e){"undefined"==typeof r&&(r=null),"undefined"==typeof e&&(e=null);var a;if(null===e)this.resetTransform();else{if(null===r)throw new Exception("Cannot remove from null parent");if(a=r.getRootParent()===e.getRootParent()){var n=r.getGlobalTransform(),s=e.getGlobalTransform(),i=this._T,o=s.inverse().multiplyBy(n).multiplyBy(i);this._T=o,this.emit("transformed",this)}else this.resetTransform()}})};module.exports=SpaceTransformer;
},{"./SpacePoint":29,"./SpaceTransform":32,"./Transform":35,"nudged":12}],34:[function(require,module,exports){
