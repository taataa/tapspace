...
},{"./SpaceNode":26,"./SpacePlane":28,"component-emitter":1}],25:[function(require,module,exports){
...
},{"./SpaceNode":26,"./SpacePlane":28,"./SpaceRectangle":30,"./SpaceTransformer":33,"component-emitter":1}],28:[function(require,module,exports){
...
},{"./SpacePoint":29,"nudged":12}],29:[function(require,module,exports){
var Transform=require("./Transform"),SpacePoint=function(t,r){this.xy=t,r.hasOwnProperty("getGlobalTransform")?this._T=r.getGlobalTransform():this._T=r._T},proto=SpacePoint.prototype;proto.equals=function(t){return this.xy[0]===t.xy[0]&&this.xy[1]===t.xy[1]&&this._T.equals(t._T)},proto.offset=function(t,r){var o=[this.xy[0]+t,this.xy[1]+r];return new SpacePoint(o,this)},proto.polarOffset=function(t,r){var o=this.xy[0]+t*Math.cos(r),n=this.xy[1]+t*Math.sin(r);return new SpacePoint([o,n],this)},proto.to=function(t){if(null===t)return this.toSpace();var r=t.getGlobalTransform();if(r.equals(this._T))return this;var o=r.inverse().multiplyBy(this._T),n=o.transform(this.xy);return new SpacePoint(n,t)},proto.toSpace=function(){var t=this._T.transform(this.xy),r={_T:Transform.IDENTITY};return new SpacePoint(t,r)},proto.transform=function(t){var r=t.transform(this.xy);return new SpacePoint(r,this)},SpacePoint.normalize=function(t,r){var o,n,i;for(i=[],o=0;o<t.length;o+=1)n=t[o],i.push(n.to(r));return i},SpacePoint.toXY=function(t){var r,o;for(o=[],r=0;r<t.length;r+=1)o.push(t[r].xy);return o},module.exports=SpacePoint;
},{"./Transform":35}],30:[function(require,module,exports){
var SpacePoint=require("./SpacePoint"),SpaceRectangle=function(n){var t=n,e=1,i=1;t.atNorm=function(n){return new SpacePoint([e*n[0],i*n[1]],t)},t.atMid=function(){return new SpacePoint([e/2,i/2],t)},t.atMidN=function(){return new SpacePoint([e/2,0],t)},t.atMidW=function(){return new SpacePoint([0,i/2],t)},t.atMidE=function(){return new SpacePoint([e,i/2],t)},t.atMidS=function(){return new SpacePoint([e/2,i],t)},t.atNW=function(){return new SpacePoint([0,0],t)},t.atNE=function(){return new SpacePoint([e,0],t)},t.atSW=function(){return new SpacePoint([0,i],t)},t.atSE=function(){return new SpacePoint([e,i],t)},t.getSize=function(){return[e,i]},t.resize=function(n){e=n[0],i=n[1],this.emit("resized",t)}};module.exports=SpaceRectangle;
...
},{"./SpaceNode":26,"./SpacePlane":28,"./SpaceRectangle":30,"./SpaceTransformer":33,"component-emitter":1}],32:[function(require,module,exports){
var Transform=require("./Transform"),SpacePoint=require("./SpacePoint"),nudged=require("nudged"),SpaceTransform=function(r,t){if(!r.hasOwnProperty("_T"))throw"invalid reference";if(t&&!t.hasOwnProperty("tx"))throw"invalid transform";"undefined"==typeof t&&(t=Transform.IDENTITY),this.T=t,r.hasOwnProperty("getGlobalTransform")?this._T=r.getGlobalTransform():this._T=r._T},proto=SpaceTransform.prototype;proto.equals=function(r){return this.T.equals(r.T)&&this._T.equals(r._T)},proto.to=function(r){var t,e,n;return null===r?this.toSpace():(t=r.hasOwnProperty("getGlobalTransform")?r.getGlobalTransform():r._T,t.equals(this._T)?this:(e=t.inverse().multiplyBy(this._T),n=e.multiplyBy(this.T.multiplyBy(e.inverse())),new SpaceTransform(r,n)))},proto.toSpace=function(){var r=this._T.multiplyBy(this.T.multiplyBy(this._T.inverse())),t={_T:Transform.IDENTITY};return new SpaceTransform(t,r)},proto.translate=function(r,t){var e,n,o,a,i;return r.hasOwnProperty("_T")&&(r=[r]),t.hasOwnProperty("_T")&&(t=[t]),e=SpacePoint.normalize(r,null),n=SpacePoint.normalize(t,null),e=SpacePoint.toXY(e),n=SpacePoint.toXY(n),o=nudged.estimate("T",e,n),a=this._T.inverse().multiplyBy(o.multiplyBy(this._T)),i={_T:this._T},new SpaceTransform(i,a.multiplyBy(this.T))},module.exports=SpaceTransform;
},{"./SpacePoint":29,"./Transform":35,"nudged":12}],33:[function(require,module,exports){
var nudged=require("nudged"),Transform=require("./Transform"),SpacePoint=require("./SpacePoint"),normalize=function(t,e){var r,n,i;for(Array.isArray(t)||(t=[t]),n=SpacePoint.normalize(t,e),i=[],r=0;r<n.length;r+=1)i.push(n[r].xy);return i},transformByEstimate=function(t,e,r,n,i){var a;"undefined"!=typeof i&&(a=normalize(i,t._parent)[0]);var s=normalize(r,t._parent),o=normalize(n,t._parent),m=nudged.estimate(e,s,o,a);t._T=m.multiplyBy(t._T),t.emit("transformed",t)},SpaceTransformer=function(t){t.setTransform=function(t){null!==this._parent&&(this._T=t,this.emit("transformed",this))},t.setGlobalTransform=function(t){if(null!==this._parent){var e=this._parent.getGlobalTransform();this._T=e.inverse().multiplyBy(t),this.emit("transformed",this)}},t.transformBy=function(t){if(null!==this._parent){var e=t.to(this._parent);this._T=e.T.multiplyBy(this._T),this.emit("transformed",this)}},t.translate=function(t,e){transformByEstimate(this,"T",t,e)},t.scale=function(t,e,r){var n="undefined"==typeof r;if(n){var i=normalize(t,this._parent)[0],a=e,s=Transform.IDENTITY.scaleBy(a,i);this._T=s.multiplyBy(this._T),this.emit("transformed",this)}else{var o=e;transformByEstimate(this,"S",o,r,t)}},t.rotate=function(t,e,r){var n="undefined"==typeof r;if(n){var i=normalize(t,this._parent)[0],a=e,s=Transform.IDENTITY.rotateBy(a,i);this._T=s.multiplyBy(this._T),this.emit("transformed",this)}else{var o=e;transformByEstimate(this,"R",o,r,t)}},t.translateScale=function(t,e){transformByEstimate(this,"TS",t,e)},t.translateRotate=function(t,e){transformByEstimate(this,"TR",t,e)},t.scaleRotate=function(t,e,r){transformByEstimate(this,"SR",e,r,t)},t.translateScaleRotate=function(t,e){transformByEstimate(this,"TSR",t,e)},t.on("removed",function(t,e,r){"undefined"==typeof e&&(e=null),"undefined"==typeof r&&(r=null);var n;if(null===r)this.resetTransform();else{if(null===e)throw new Exception("Cannot remove from null parent");if(n=e.getRootParent()===r.getRootParent()){var i=e.getGlobalTransform(),a=r.getGlobalTransform(),s=this._T,o=a.inverse().multiplyBy(i).multiplyBy(s);this._T=o,this.emit("transformed",this)}else this.resetTransform()}})};module.exports=SpaceTransformer;
},{"./SpacePoint":29,"./Transform":35,"nudged":12}],34:[function(require,module,exports){
...
},{"component-emitter":1,"loadimages":2}],35:[function(require,module,exports){
var nudged=require("nudged");module.exports=nudged.Transform;
},{"nudged":12}],36:[function(require,module,exports){
