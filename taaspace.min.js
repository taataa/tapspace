...
var nudged=require("nudged"),SpacePoint=require("./SpacePoint"),SpaceTransform=require("./SpaceTransform"),at=function(n){if(2!==n.length)throw"Invalid point, use array [x, y]";return new SpacePoint(this,n)},SpacePlane=function(n){n._T=nudged.Transform.IDENTITY,n.at=at,n.getLocalTransform=function(){return null===this._parent?new SpaceTransform(this):new SpaceTransform(this._parent,this._T)},n.getGlobalTransform=function(){var n,r;if(null===this._parent)return r={_T:nudged.Transform.IDENTITY},new SpaceTransform(r);for(n=this._T,r=this._parent;null!==r._parent;)n=r._T.multiplyBy(n),r=r._parent;return new SpaceTransform(r,n)},n.resetTransform=function(){this._T=nudged.Transform.IDENTITY}};module.exports=SpacePlane;
},{"./SpacePoint":29,"./SpaceTransform":32,"nudged":12}],29:[function(require,module,exports){
...
},{"nudged":12}],30:[function(require,module,exports){
