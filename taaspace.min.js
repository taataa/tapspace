...
var Emitter=require("component-emitter"),SpaceContainer=require("./SpaceContainer"),SpacePlane=require("./SpacePlane"),Transformer=require("./Transformer"),SpaceRectangle=require("./SpaceRectangle"),move=require("movejs");move.defaults={duration:0};var HTMLSpaceView=function(e,t){if(!("tagName"in t))throw"Container should be a DOM Element";Emitter(this),SpaceContainer(this),SpacePlane(this),Transformer(this),SpaceRectangle(this);var n=this;this._el=t,this._elements={},this._spacetaas={},function(){var e=n._el.clientWidth,t=n._el.clientHeight;n.resize([e,t])}();var a=function(e,t){var a=t.getGlobalTransform(),i=n._T.inverse().multiplyBy(a),r=8,s=i.s.toFixed(r),o=i.r.toFixed(r),c=i.tx.toFixed(r),d=i.ty.toFixed(r);move(e).matrix(s,o,-o,s,c,d).end()},i=function(e){if(n._elements.hasOwnProperty(e.id));else{var t=e.taa,i=new Image(256,256);i.src=t.image.src,i.id=n.id+"/"+e.id,i.className="taaspace-taa",n._el.appendChild(i),n._elements[e.id]=i,n._spacetaas[e.id]=e,a(i,e)}},r=function(e){var t;n._elements.hasOwnProperty(e.id)&&(t=n._elements[e.id],n._el.removeChild(t),delete n._elements[e.id],delete n._spacetaas[e.id])},s=function(e){var t;n._elements.hasOwnProperty(e.id)&&(t=n._elements[e.id],a(t,e))};this.on("added",function(e,t){t.on("contentAdded",i),t.on("contentRemoved",r),t.on("contentTransformed",s)}),this.on("removed",function(e,t){t.off("contentAdded",i),t.off("contentRemoved",r),t.off("contentTransformed",s)}),this.on("transformed",function(){var e,t,i;for(e in n._elements)n._elements.hasOwnProperty(e)&&(t=n._elements[e],i=n._spacetaas[e],a(t,i))}),this.getElementBySpaceTaa=function(e){return this._elements.hasOwnProperty(e.id)?this._elements[e.id]:void 0},this.getSpaceTaaByElementId=function(e){var t=e.split("/"),n=t[0],a=t[1];return this.id===n&&this._spacetaas.hasOwnProperty(a)?this._spacetaas[a]:null},this.getRootElement=function(){return this._el},this.setParent(e)};module.exports=HTMLSpaceView;
},{"./SpaceContainer":25,"./SpacePlane":26,"./SpaceRectangle":28,"./Transformer":32,"component-emitter":1,"movejs":3}],24:[function(require,module,exports){
...
var Emitter=require("component-emitter"),seqid=require("seqid")(0),SpaceContainer=function(t){t.id=seqid.next().toString(),t._parent=null,t._content={},t._transformedHandlers={},t.has=function(t){return t._parent===this},t.setParent=function(t){null===this._parent&&null!==t&&(this._parent=t,this._parent._addChild(this),this.emit("added",this,this._parent))},t.remove=function(){if(null!==this._parent){var t=this._parent;this._parent=null,t._removeChild(this),this.emit("removed",this,t)}},t._addChild=function(t){var e=t,n=this;this._content[e.id]=e;var i=function(){n.emit("contentTransformed",e)};e.on("transformed",i),e.on("contentTransformed",i),this._transformedHandlers[e.id]=i,this.emit("contentAdded",e)},t._removeChild=function(t){var e=t;delete this._content[e.id];var n=this._transformedHandlers[e.id];delete this._transformedHandlers[e.id],e.off("transformed",n),e.off("contentTransformed",n),this.emit("contentRemoved",e)}};module.exports=SpaceContainer;
},{"component-emitter":1,"seqid":22}],26:[function(require,module,exports){
var nudged=require("nudged"),SpacePoint=require("./SpacePoint"),at=function(n){if(2!==n.length)throw"Invalid point, use array [x, y]";return new SpacePoint(n,this)},SpacePlane=function(n){n._T=nudged.Transform.IDENTITY,n.at=at,n.getTransform=function(){return this._T},n.getGlobalTransform=function(){return null===this._parent?this._T:this._parent.getGlobalTransform().multiplyBy(this._T)},n.resetTransform=function(){this._T=nudged.Transform.IDENTITY},n.on("removed",function(){n.resetTransform()})};module.exports=SpacePlane;
