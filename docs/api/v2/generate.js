...
yamdog.generate({
  ...
  names: {
    ...
    'Node': 'tapspace.components.Node',
    'Space': 'tapspace.components.Space',
    'Transformer': 'tapspace.components.Transformer',
    'Viewport': 'tapspace.components.Viewport',
    'ViewportControl': 'tapspace.components.ViewportControl',
    'ViewportControls': 'tapspace.components.ViewportControls',
