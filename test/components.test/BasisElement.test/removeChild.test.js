...
module.exports = (test, container, tapspace) => {
  ...
  test('BasisElement:removeChild', (t) => {
    // Setup
    ...
    const na = new BasisElement(space.element.querySelector('#affine-a'))
    const naa = new BasisElement(space.element.querySelector('#affine-aa'))
    const naaa = new BasisElement(space.element.querySelector('#affine-aaa'))
    const naab = new BasisElement(space.element.querySelector('#affine-aab'))
