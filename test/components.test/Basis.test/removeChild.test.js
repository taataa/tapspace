...
module.exports = (test, container, tapspace) => {
  ...
  test('Basis:removeChild', (t) => {
    ...
    const na = new Basis(space.element.querySelector('#affine-a'))
    const naa = new Basis(space.element.querySelector('#affine-aa'))
    const naaa = new Basis(space.element.querySelector('#affine-aaa'))
    const naab = new Basis(space.element.querySelector('#affine-aab'))
